...
/**
 * 数据库mysqli操作类
 * Created by Roger On 2010-09-27
 * Modified by Roger On 2010-09-27
 */
class DB_MYSQLI
{
	var $connid;
...
//		}
	...
	{
		if(!is_array($string)) return str_replace(array('\n', '\r'), array(chr(10), chr(13)), mysqli_real_escape_string(preg_replace($this->search, $this->replace, $string), $this->connid));
